    ...
    >
       <section className="bg-opacity-0 dark:bg-gray-900 ">
            ...
            <div className="flex flex-col justify-center items-center gap-6 mt-0 md:mt-40  md:ml-10 md:pl-20 md:py-10">
                ...
                <div className="text-white hover:text-blue-500 border-2 border-myColor-2 rounded-lg p-2 hover:bg-white bg-myColor-2">
                    <a href="mailto:byesenia04@yahoo.com">byesenia04@yahoo.com</a>
                </div>
                <h2 className="text-2xl text-myColor-3">Phone:</h2>
                <div className="text-white hover:text-blue-500 border-2 border-myColor-2 rounded-lg p-2 hover:bg-white bg-myColor-2">
                    <a href="tel:1-407-693-1515">(407)693-1515</a>
                </div>
            
                <h2 className="text-2xl text-myColor-3">GitHub:</h2>
                <div className="text-white hover:text-blue-500 border-2 border-myColor-2 rounded-lg p-2 hover:bg-white bg-myColor-2">
                    <a href="https://github.com/Yeseniax2">yesenia</a>
                </div>
            </div>
        </motion.div>
